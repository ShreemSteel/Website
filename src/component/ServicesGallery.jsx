...
const services = [
  ...
  { icon: <Trophy size={24} />, title: "READY TO USE PRODUCTS", description: "From Concept to Construction, Our Company also provide various processed products like TUBES & PIPES" },
  { icon: <Cog size={24} />, title: "SMOOTH OPERATIONS", description: "We ensure each product meets stringent quality controls, providing you with the confidence that your projects will be built on a foundation of strength." },
  { icon: <Tag size={24} />, title: "VALUE PRODUCTS", description: "We focus on strength and low cost, our steel delivers exceptional performance and durability, providing great value for every application" },
];
