...
import TMT_Bar from '../../assets/images/TMT_Bar.jpg';
import Wire_Rod from '../../assets/images/wire_rod.jpg';
    ...
    <div className="categories-container">
      ...
      <div className="cards-container">
        {[{ img: CRERWTP, title: 'CR ERW Tubes/Pipes', text: 'Cold Rolled Electric Resistance Welded tubes/pipes.' },
          ...
          { img: TMT_Bar, title: 'TMT Bar', text: 'A TMT bar is a type of high-strength steel reinforcement bar used in construction'},
          { img: Wire_Rod, title: 'Wire Rods', text: 'Wire rod is a type of metal product that is typically produced in coil form.'},
        ]
          .map((item, index) => (
            <motion.div
              key={index}
